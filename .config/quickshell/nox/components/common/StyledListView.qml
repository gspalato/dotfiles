...
ListView {
    ...
    property real touchpadScrollFactor: ConfigJ?.options.interactions.scrolling.touchpadScrollFactor ?? 100
    property real mouseScrollFactor: ConfigJ?.options.interactions.scrolling.mouseScrollFactor ?? 50
    property real mouseScrollDeltaThreshold: ConfigJ?.options.interactions.scrolling.mouseScrollDeltaThreshold ?? 120
    ...
    MouseArea {
        visible: ConfigJ?.options.interactions.scrolling.fasterTouchpadScroll
        anchors.fill: parent
