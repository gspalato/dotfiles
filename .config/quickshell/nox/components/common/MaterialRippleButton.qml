...
Button {
    ...
    property color colBackground: ColorUtils.alpha(Appearance?.material_colors.surface, 1) || "transparent"
    property color colBackgroundHover: Appearance?.material_colors.surface ?? "#E5DFED"
    property color colBackgroundToggled: Appearance?.material_colors.primary ?? "#65558F"
    property color colBackgroundToggledHover: Appearance?.material_colors.primary ?? "#77699C"
    property color colRipple: Appearance?.material_colors.surface ?? "#D6CEE2"
    property color colRippleToggled: Appearance?.material_colors.primary ?? "#D6CEE2"

    opacity: root.enabled ? 1 : 0.4
    property color buttonColor: ColorUtils.alpha(root.toggled ? 
