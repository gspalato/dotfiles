...
Common.MaterialRippleButton {
    ...
    Common.PointingHandInteraction {}
    ...
    RowLayout {
        ...
        ColumnLayout {
            ...
            RowLayout {
                ...
                Common.StyledText { // Item name/content
                    Layout.fillWidth: true
                    id: nameText
            ...
            Loader { // Clipboard image preview
                ...
                sourceComponent: Common.CliphistImage {
                    Layout.fillWidth: true
        ...
        RowLayout {
            ...
            Repeater {
                ...
                delegate: Common.MaterialRippleButton {
                    id: actionButton
                    required property var modelData
                    ...
                    contentItem: Item {
                        ...
                        Loader {
                            ...
                            sourceComponent: Common.MaterialSymbol {
