...
Common.Button {
    ...
    property color textColor: "#ffffff" //isConnected ? Appearance.material_colors.on_surface : Appearance.material_colors.on_surface
    ...
    RowLayout {
        ...
        RowLayout {
            ...
            Common.StyledText {
                text: isConnected ? Network.networkName : "Wi-Fi"
