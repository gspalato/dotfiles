...
Singleton {
    ...
    Process {
        ...
        command: ["find", FileUtils.trimFileProtocol(Qt.resolvedUrl(Directories.config + "/quickshell/end4/translations/").toString()), "-name", "*.json", "-exec", "basename", "{}", ".json", ";"]
        running: true
    ...
    FileView {
        ...
        path: root.languageCode?.length > 0 ? Qt.resolvedUrl(Directories.config + "/quickshell/end4/translations/" + root.languageCode + ".json") : ""
