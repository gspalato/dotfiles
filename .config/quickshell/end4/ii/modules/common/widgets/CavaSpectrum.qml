...
Canvas {
    ...
    Process {
        id: proc
        command: ["cava", "-p", `${FileUtils.trimFileProtocol(Directories.scriptPath)}/cava/cava.toml`]
        running: true
    ...
    function onPaint(values) {
        ...
        context.fillStyle = Appearance.m3colors.m3onSurface; // White color for the bars
