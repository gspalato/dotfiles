...
Singleton {
    ...
    m3colors: QtObject {
        ...
        property color m3sourceColor: "#91689E" 
    ...
    colors: QtObject {
        ...
        property color colGroupBorder: ColorUtils.applyAlpha(Qt.lighter(m3colors.m3surfaceContainer, 1.75), .45)
    }
    ...
    font: QtObject {
        property QtObject family: QtObject {
            ...
            property string expressive: "Unbounded"
        }
